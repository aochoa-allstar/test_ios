...
class HazardsTxtAreaSteper extends StatelessWidget {
  final JsasSteperFormController controller;
  HazardsTxtAreaSteper({Key? key, required this.controller}) : super(key: key);
  late double h, w;
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: PhysicalModel(
              ...
              child: TextFormField(
                maxLines: null,
                controller: controller.hazards,
                style: ThemeWhite().labelHomeTitles(Colors.black),
                onChanged: (value) {
                  if (controller.hazards.text.isEmpty) {
                ...
                autofocus: false,
                decoration: StyleInput().textAreaStyle('new_jsas_hazards'.tr, Colors.white),
              ),
            ),
          ),
