...
class ControlsSteper extends StatelessWidget {
  final JsasSteperFormController controller;
  ControlsSteper({Key? key, required this.controller}) : super(key: key);
  late double h, w;
  @override
          ...
          Container(
            ...
            child: PhysicalModel(
              ...
              child: TextFormField(
                ...
                onChanged: (value) {
                  if (controller.controls.text.isEmpty) {
                ...
                autofocus: false,
                decoration:
                    StyleInput().textAreaStyle('new_jsas_controls'.tr, Colors.white),
              ),
            ),
          ),
