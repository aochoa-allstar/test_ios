...
class CustomeDropDownEquipment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownButtonFormField2(
      ...
      decoration: InputDecoration(
        //label: const Text('Tractor/Truck'),
      ...
      onChanged: (value) {
        ...
        if (type == 'trailer1') {
          controller.selectTrailer1(value);
        }
        if (type == 'trailer2') {
          controller.selectTrailer2(value);
        }
