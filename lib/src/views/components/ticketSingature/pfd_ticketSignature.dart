...
class PDFWorkOrderSignature extends StatefulWidget {
  final int workerOrderID;
  final String prefix;
  final dynamic parentController;
  PDFWorkOrderSignature({
    Key? key,
  ...
  @override
  _PDFWorkOrderSignatureState createState() => _PDFWorkOrderSignatureState();
}

class _PDFWorkOrderSignatureState extends State<PDFWorkOrderSignature> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Ticket #${widget.prefix}'),
          centerTitle: true,
          leading: IconButton(
              onPressed: () {
                //
